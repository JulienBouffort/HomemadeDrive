...
pub fn t(key: &str) -> String {
    ...
    match (key, lang) {
        ...
        ("drag_drop", Lang::Fr) => "Glissez vos photos et vidéos ici",
        ("drag_drop", Lang::Pl) => "Przeciągnij tutaj swoje zdjęcia i filmy",
        ...
        ("website_subtitle", Lang::Pl) => "Udostępnij swoje najpiękniejsze wspomnienia z ślubu ❤️",
        ...
        ("gallery_subtitle", Lang::Pl) => "Wszystkie zdjęcia udostępnione przez gości",
